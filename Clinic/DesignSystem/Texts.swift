...
extension Text {
    static let hello = Text("Hello,")
    static let hi = Text("Hi ")
    static let name = Text("James")
    static let selectedDoctorName = Text("Dr. Imran Syahir")
    ...
    static let covid = Text("Covid 19")
